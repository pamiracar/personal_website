...
class Navigationawer extends StatelessWidget {
  const Navigationawer({super.key});
  ...
  Widget buildHeader(BuildContext context) => Container(
    child: Column(
      children: [
        ...
        ClipRRect(
          borderRadius: BorderRadius.circular(300),
          child: Image.asset("assets/images/logoPamir.png", width: 130),
        ),
        SizedBox(height: 30),
    ...
    child: Wrap(
      ...
      children: [
        ListTile(
          ...
          onTap: () => Get.offAndToNamed(AppRoutes.HO),
        ),
        const Divider(),
        ListTile(
          leading: const Icon(Icons.local_activity),
          title: const Text("Interests"),
          onTap: () => Get.offAndToNamed(AppRoutes.DEV),
        ),
        const Divider(),
        ListTile(
          leading: const Icon(Icons.phone),
          title: const Text("Contact"),
          onTap: () => Get.offAndToNamed(AppRoutes.CON),
        ),
      ],
    ),
  );
